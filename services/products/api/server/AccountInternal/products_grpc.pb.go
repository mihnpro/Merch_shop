...
const (
	...
	ProductService_DeactivateProduct_FullMethodName = "/products.ProductService/DeactivateProduct"
	ProductService_ListCategories_FullMethodName    = "/products.ProductService/ListCategories"
	ProductService_CreateCategory_FullMethodName    = "/products.ProductService/CreateCategory"
	ProductService_UpdateCategory_FullMethodName    = "/products.ProductService/UpdateCategory"
)
...
type ProductServiceClient interface {
	...
	DeactivateProduct(ctx context.Context, in *DeactivateProductRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *productServiceClient) DeactivateProduct(ctx context.Context, in *DeactivateProductRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	DeactivateProduct(context.Context, *DeactivateProductRequest) (*emptypb.Empty, error)
	// --- Справочник категорий ---
...
func (UnimplementedProductServiceServer) DeactivateProduct(context.Context, *DeactivateProductRequest) (*emptypb.Empty, error) {
