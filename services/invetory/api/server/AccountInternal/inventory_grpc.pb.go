...
const (
	...
	InventoryService_ReleaseReserve_FullMethodName = "/inventory.InventoryService/ReleaseReserve"
...
type InventoryServiceClient interface {
	...
	ReserveStock(ctx context.Context, in *ReserveStockRequest, opts ...grpc.CallOption) (*Reservation, error)
	// Снятие резерва при отмене заказа; идемпотентно по order_id
	// (вызывает Order Service).
	ReleaseReserve(ctx context.Context, in *ReleaseReserveRequest, opts ...grpc.CallOption) (*Reservation, error)
...
func (c *inventoryServiceClient) ReserveStock(ctx context.Context, in *ReserveStockRequest, opts ...grpc.CallOption) (*Reservation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Reservation)
...
func (c *inventoryServiceClient) ReleaseReserve(ctx context.Context, in *ReleaseReserveRequest, opts ...grpc.CallOption) (*Reservation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Reservation)
	err := c.cc.Invoke(ctx, InventoryService_ReleaseReserve_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServiceServer interface {
	...
	// Резервирование под заказ; идемпотентно по order_id
	// (вызывает консьюмер order.created).
	ReserveStock(context.Context, *ReserveStockRequest) (*Reservation, error)
	// Снятие резерва при отмене заказа; идемпотентно по order_id
	// (вызывает Order Service).
	ReleaseReserve(context.Context, *ReleaseReserveRequest) (*Reservation, error)
	// Корректировка остатка админом по дельте; идемпотентно по operation_id.
...
func (UnimplementedInventoryServiceServer) ReserveStock(context.Context, *ReserveStockRequest) (*Reservation, error) {
	return nil, status.Error(codes.Unimplemented, "method ReserveStock not implemented")
}
func (UnimplementedInventoryServiceServer) ReleaseReserve(context.Context, *ReleaseReserveRequest) (*Reservation, error) {
	return nil, status.Error(codes.Unimplemented, "method ReleaseReserve not implemented")
}
...
func _InventoryService_ReleaseReserve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseReserveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).ReleaseReserve(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_ReleaseReserve_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).ReleaseReserve(ctx, req.(*ReleaseReserveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InventoryService_ReleaseReserve_Handler,
		},
		{
