...
INSERT INTO roles (code, name, description) VALUES
    ('user',  'Сотрудник',
     'Может просматривать каталог, управлять своей корзиной, оформлять заказы, видеть свои заказы и баланс.'),
    ('admin', 'Администратор',
     'Всё, что может сотрудник, плюс управление каталогом, остатками, начисление баллов, управление пользователями и заказами.');
